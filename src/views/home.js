    ...
    <div className="home-container">
        ...
        <div className="home-max-content-width-container">
          ...
          <div className="home-content-container">
            <div className="home-circuit-analysis">
              ...
              <div className="home-container06">
                ...
                <span className="home-text12">
                  Amplifier Analysis in the s-Domain.
                </span>
              </div>
            </div>
            <div className="home-signal-processing">
              <h2 className="Card-Heading home-text13">Signal Processing</h2>
            ...
            <div className="home-logic-design-and-code">
              <h2 className="Card-Heading home-text19">
          ...
          <div className="home-content-container1">
            <div className="home-software-tools">
              ...
              <div className="home-container18">
                ...
                <span className="home-text26 Card-Text">Altium Designer</span>
              </div>
            ...
            <div className="home-work-experience">
              <h2 className="Card-Heading home-text29">Work Experience</h2>
              <div className="home-container21">
                <svg viewBox="0 0 1024 1024" className="home-icon42">
                  <path d="M170 512q0-140 101-241t241-101 241 101 101 241-101 241-241 101-241-101-101-241z"></path>
                </svg>
                <span className="home-text30 Card-Text">
                  Employed at Jersey Mike&apos;s Subs from October 2020 until
                  August 2023. I left to focus on my school work for a semester.
                </span>
              </div>
              <div className="home-container22">
                ...
                <span className="home-text31 Card-Text">
                  I developed much better &apos;people skills&apos; during my
                  time as a Crew Member, I never encountered a situation I was
                  unable to handle.
                </span>
              </div>
              <div className="home-container23">
                ...
                <span className="home-text32 Card-Text">
                  I developed good time management and multi-tasking skills. I
                  learned to perform under high volume conditions.
                </span>
              </div>
              <div className="home-container24">
                ...
                <span className="home-text33 Card-Text">
                  I would like to note that the Jersey Mike&apos;s location I
                  was employed at treated me exceptionally well, and I enjoyed
                  my time with the company.
                </span>
              </div>
            </div>
            <div className="home-something">
              <h2 className="Card-Heading home-text34">Other Skills</h2>
              <div className="home-container25">
                <svg viewBox="0 0 1024 1024" className="home-icon50">
                  <path d="M170 512q0-140 101-241t241-101 241 101 101 241-101 241-241 101-241-101-101-241z"></path>
                </svg>
                <span className="home-text35 Card-Text">Soldering</span>
              </div>
      ...
      <div className="home-features">
        <div className="home-heading-container1">
          <h2 className="home-heading3 Section-Heading">Personal Interests</h2>
        ...
        <div className="home-cards-container">
          ...
          <div className="home-card2">
            <div className="home-icon-container2">
              <svg viewBox="0 0 865.7188571428571 1024" className="home-icon60">
      ...
      <div className="home-clients">
        <div className="home-heading-container2">
          <h1 className="home-text42 Section-Heading"> Lab Reports</h1>
      ...
      <div className="home-footer-container">
        <div className="home-footer">
          ...
          <div className="home-copyright-container">
            <svg viewBox="0 0 1024 1024" className="home-icon68">
